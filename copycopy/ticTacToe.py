...
class State:
    ...
    def play(self, rounds=100):
        ...
        for i in range(rounds):
            # with open("game_states.txt", 'a') as file:
            #     file.write(f"Game {i}:\n")
            # with open("allmovesgame_states.txt", 'a') as file:
            #     file.write(f"Game {i}:\n")
            ...
            while not self.isEnd:
                ...
                # with open("allmovesgame_states.txt", 'a') as file:
                #             file.write("new move -1\n")
                #             for x in range(BOARD_ROWS):
                #                 for y in range(BOARD_COLS):
                #                     for z in range(BOARD_LAYERS):
                #                         file.write(f"{self.board[x, y, z]} \t")
                #                     file.write("\n")
                #                 file.write("\n\n")
                #             file.write("\n\n")
...
class Player:
    ...
    def feedReward(self, reward):
        for st in reversed(self.states):
            ...
            #print[list(self.states_value.keys())[counter]]
            # print(st)
            # print(reward)
